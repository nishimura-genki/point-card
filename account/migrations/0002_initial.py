# Generated by Django 3.1.2 on 2020-12-25 05:08
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(blank=True, choices=[
                 (1, '男性'), (2, '女性'), (3, 'その他')], null=True, verbose_name='性別')),
                ('age', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(
                    1), django.core.validators.MaxValueValidator(100)], verbose_name='年齢')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_point', models.BooleanField(
                    default=False, verbose_name='ポイント機能を使用する')),
                ('has_stamp', models.BooleanField(
                    default=False, verbose_name='スタンプ機能を使用する')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(
                    max_length=10, null=True, verbose_name='action')),
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                               to='account.customer', verbose_name='customer')),
                ('shop', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                           to='account.shop', verbose_name='shop')),
            ],
        ),
        migrations.CreateModel(
            name='PointCard',
